...
const dashboardNavigation = [
  { label: '运营总览', to: '/platform/dashboard', current: true },
  { label: '学情总览', to: '/platform/students' },
  { label: '内容管理', to: '/platform/content' },
  { label: '人员管理', to: '/platform/institutions' },
  { label: '交易管理', to: '/platform/goods' },
];
